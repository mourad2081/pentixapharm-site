    ...
    <div className="bg-[#F8FAFD] min-h-screen text-slate-800 pb-32">
      ...
      <section className="relative pt-44 pb-28 overflow-hidden bg-white border-b border-slate-200">
        <div className="absolute inset-0 z-0 opacity-[0.02]">
           <div className="absolute inset-0 bg-[radial-gradient(#002A54_1.5px,transparent_1.5px)] bg-[size:45px_45px]" />
        </div>
        <div className="container mx-auto px-6 relative z-10 max-w-5xl">
          <motion.div initial="hidden" animate="show" variants={stagger} className="text-center">
            ...
            <motion.h1 variants={fadeUp} className="text-6xl md:text-7xl font-heading font-extrabold text-[#002A54] mb-8 drop-shadow-sm leading-tight italic">Science of <span className="text-cyan">Precision</span></motion.h1>
                 ...
                 <motion.div key="cxcr4" initial={{opacity:0, scale:0.98, x:20}} animate={{opacity:1, scale:1, x:0}} exit={{opacity:0, scale:0.98, x:-20}} className="relative z-10 w-full">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                       <div>
                          ...
                          <h2 className="text-4xl lg:text-5xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight">The <span className="italic">CXCR4</span> Hub</h2>
                          ...
                          <div className="space-y-6">
                             <div className="bg-[#F8FAFD] p-8 rounded-3xl border border-slate-100 flex gap-6 group hover:translate-x-2 transition-all">
                                ...
                                <div>
                                   <p className="text-[#002A54] font-extrabold text-lg mb-1 italic tracking-tight">Onco-Selection</p>
                             ...
                             <div className="bg-[#F8FAFD] p-8 rounded-3xl border border-slate-100 flex gap-6 group hover:translate-x-2 transition-all">
                                ...
                                <div>
                                   <p className="text-[#002A54] font-extrabold text-lg mb-1 italic tracking-tight">Targeted Ablation</p>
                 ...
                 <motion.div key="cd24" initial={{opacity:0, scale:0.98, x:20}} animate={{opacity:1, scale:1, x:0}} exit={{opacity:0, scale:0.98, x:-20}} className="relative z-10 w-full">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                       <div>
                          ...
                          <h2 className="text-4xl lg:text-5xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight">Glycan <span className="italic text-[#A7303E]">Differentiation</span></h2>
                          ...
                          <div className="p-8 bg-[#A7303E]/5 border border-[#A7303E]/20 rounded-3xl relative overflow-hidden">
                             <div className="relative z-10">
                                <h4 className="font-heading font-extrabold text-[#002A54] text-xl mb-3">Mechanism of Action: ADCC</h4>
               ...
               {activeTab === "theranostics" && (
                 <motion.div key="theranostics" initial={{opacity:0, scale:0.98, x:20}} animate={{opacity:1, scale:1, x:0}} exit={{opacity:0, scale:0.98, x:-20}} className="relative z-10 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16">
                       <h2 className="text-4xl lg:text-5xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight">Dual-Action <span className="italic">Scout & Sniper</span></h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                       {[
                         ...
                         <div key={i} className="bg-[#F8FAFD] p-10 rounded-[3rem] border border-slate-100 flex flex-col h-full group hover:bg-white hover:border-teal/20 hover:shadow-xl transition-all">
                            ...
                            <h4 className="font-heading font-extrabold text-[#002A54] text-xl mb-4 italic">{s.step}</h4>
                 ...
                 <motion.div key="cmc" initial={{opacity:0, scale:0.98, x:20}} animate={{opacity:1, scale:1, x:0}} exit={{opacity:0, scale:0.98, x:-20}} className="relative z-10 w-full">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                       <div>
                          ...
                          <h2 className="text-4xl lg:text-5xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight italic">Global Supply <span className="text-slate-400 font-sans tracking-tighter not-italic">CMC+</span></h2>
                          <p className="text-slate-600 text-lg leading-relaxed mb-10 font-light">
                       ...
                       <div className="bg-[#002A54] rounded-[3.5rem] p-1 shadow-2xl overflow-hidden relative group">
                 ...
                 <motion.div key="discovery" initial={{opacity:0, scale:0.98, x:20}} animate={{opacity:1, scale:1, x:0}} exit={{opacity:0, scale:0.98, x:-20}} className="relative z-10 w-full">
                    <div className="flex flex-col md:flex-row gap-16 items-center">
                       <div className="md:w-1/2">
                          <h2 className="text-4xl lg:text-5xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight italic">Molecular <span className="text-emerald">Identification</span></h2>
                          <p className="text-slate-600 text-lg leading-relaxed mb-10 font-light italic">
                          ...
                          <button className="flex items-center gap-3 px-8 py-4 bg-[#002A54] text-white font-bold rounded-full text-sm hover:bg-emerald transition-all shadow-xl shadow-navy/20">
                       ...
                       <div className="md:w-1/2 grid grid-cols-2 gap-6">
                           {[
                             ...
                             <div key={i} className="bg-white border border-slate-100 p-8 rounded-[2.5rem] shadow-xl group hover:border-emerald/30 transition-all">
                                ...
                                <h4 className="font-bold text-[#002A54] mb-2">{b.lab}</h4>
      ...
      <section className="py-24 text-center container mx-auto px-6">
         <div className="bg-[#002A54] rounded-[4rem] p-16 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
               ...
               <button className="px-10 py-4 bg-[#00B1AB] text-[#002A54] font-heading font-extrabold rounded-full hover:bg-white transition-all shadow-2xl">
