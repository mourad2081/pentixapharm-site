    ...
    <div className="bg-[#F8FAFD] min-h-screen text-slate-800 pb-32">
      ...
      <section className="relative pt-44 pb-28 overflow-hidden bg-[#031835] text-white">
        <div className="absolute inset-0 z-0 opacity-10">
           ...
           <div className="absolute inset-0 bg-gradient-to-t from-[#031835] via-transparent to-transparent" />
        </div>
         ...
         <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
               ...
               <div className="space-y-12">
                  <div className="mb-10">
                     <h2 className="text-4xl font-heading font-extrabold text-[#031835] italic mb-6">Current <span className="text-teal">Opportunities</span></h2>
                     ...
                     {[
                       ...
                       <div key={i} className="p-10 bg-white border border-slate-100 rounded-[3.5rem] shadow-xl hover:border-cyan/30 transition-all group">
                          <div className="flex items-center gap-4 mb-6">
                             <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center shrink-0 group-hover:bg-[#031835] group-hover:text-white transition-all"><Zap className="w-5 h-5 text-cyan" /></div>
                             <span className="text-[10px] font-extrabold text-teal uppercase tracking-widest italic">{item.status}</span>
                          </div>
                          <h4 className="text-2xl font-heading font-extrabold text-[#031835] mb-3 italic">{item.title}</h4>
               ...
               {/* Submission Box */}
               <div className="lg:sticky lg:top-40 h-fit bg-[#031835] text-white p-14 rounded-[4rem] shadow-2xl relative overflow-hidden group">
      ...
      <section className="py-24 bg-white border-y border-slate-100">
         <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-16 max-w-3xl mx-auto">
               <h3 className="text-3xl font-heading font-extrabold text-[#031835] italic">Why Partner with Pentixapharm?</h3>
            </div>
            <div className="grid md:grid-cols-3 gap-10">
               {[
                 ...
                 <div key={i} className="flex gap-6 items-start p-10 bg-[#F8FAFD] border border-slate-100 rounded-[3rem] group hover:bg-[#031835] hover:text-white transition-all shadow-xl hover:-translate-y-2">
                    <v.icon className={"w-8 h-8 text-teal mx-auto mb-6 group-hover:text-cyan transition-colors shrink-0"} />
                    <div className="flex-1">
                       <h4 className="text-xl font-heading font-extrabold text-[#031835] mb-3 italic group-hover:text-white transition-colors">{v.title}</h4>
