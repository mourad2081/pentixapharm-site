...
export function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed bottom-28 right-6 z-[98] w-14 h-14 flex items-center justify-center hover:scale-110 active:scale-95 transition-transform animate-in fade-in zoom-in"
