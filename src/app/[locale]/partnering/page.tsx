    ...
    <div className="bg-[#F8FAFD] min-h-screen text-slate-800 pb-32">
      ...
      <section className="relative pt-44 pb-28 overflow-hidden bg-white border-b border-slate-200 shadow-sm">
        <div className="absolute inset-0 z-0 opacity-5">
           <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
              <pattern id="dotGrid" width="40" height="40" patternUnits="userSpaceOnUse">
                 <circle cx="20" cy="20" r="1.5" fill="#002A54" />
              </pattern>
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-4xl text-center">
          <motion.div initial="hidden" animate="show" variants={stagger}>
            ...
            <motion.h1 variants={fadeUp} className="text-6xl md:text-7xl font-heading font-extrabold text-[#002A54] mb-8 leading-tight italic">Global <span className="text-cyan">Alliance</span> Strategy</motion.h1>
         ...
         <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12">
               <motion.div initial={{opacity:0, scale:0.98, y:20}} whileInView={{opacity:1, scale:1, y:0}} viewport={{once:true}} className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-slate-100 relative group overflow-hidden">
                  ...
                  <h3 className="text-3xl font-heading font-extrabold text-[#002A54] mb-6 flex items-center gap-4 italic"><Handshake className="text-cyan w-10 h-10"/> Licensing & Assets</h3>
               ...
               <motion.div initial={{opacity:0, scale:0.98, y:20}} whileInView={{opacity:1, scale:1, y:0}} viewport={{once:true}} transition={{delay:0.1}} className="bg-[#002A54] p-12 rounded-[3.5rem] text-white shadow-2xl shadow-navy/20 relative group overflow-hidden ">
      ...
      <section className="py-24 bg-white border-y border-slate-100">
         <div className="container mx-auto px-6 max-w-5xl text-center">
            <h2 className="text-4xl font-heading font-extrabold text-[#002A54] mb-16">Why Partner with <span className="text-cyan italic">Pentixa?</span></h2>
      ...
      <section className="py-24 text-center">
         <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto">
               <h3 className="text-3xl font-heading font-extrabold text-[#002A54] mb-6 tracking-tight italic">Initiate a Strategic Dialogue</h3>
               ...
               <a href="mailto:partnering@pentixapharm.com" className="px-12 py-5 bg-[#002A54] text-white font-heading font-extrabold rounded-full hover:bg-cyan hover:text-navy transition-all shadow-2xl inline-flex items-center gap-3">
