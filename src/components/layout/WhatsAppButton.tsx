  ...
  return (
    <div className="fixed bottom-6 right-6 z-[99] flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-2xl shadow-black/20 p-6 w-72 border border-border"
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-bold text-navy text-sm">Mourad Labadi</p>
      ...
      <motion.button
        ...
        className="relative w-16 h-16 rounded-full bg-[#25D366] text-white shadow-2xl shadow-[#25D366]/40 flex items-center justify-center"
      >
        {/* Pulse ring */}
        {showPulse && (
          <>
